  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'agent',
      content:
        "Hi, I'm MnadAI, your AI agent on the Monad Mainnet. I can help you perform operations like creating tokens, managing wallets, and more. Try 'help' to see available commands or start by setting your wallet with 'setWallet <privateKey>'.",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your request to MnadAI agent was successful.',
        variant: 'default',
      });
    } catch (error) {
      ...
      const errorMessage: Message = {
        role: 'agent',
        content:
          'Sorry, I encountered an error processing your request. Please check that the VITE_API_ENDPOINT environment variable is set correctly to point to the MnadAI agent service.',
        timestamp: new Date().toLocaleTimeString(),
      };
      ...
      toast({
        ...
        description: 'Failed to reach the MnadAI agent service. Please check your VITE_API_ENDPOINT configuration.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
