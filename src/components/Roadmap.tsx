...
//       status: 'completed',
//       phase: "Phase 1",
//       title: "Mainnet Launch & Core Features",
//       description: "MnadAI successfully launched on Monad Mainnet with core AI functionality.",
//       icon: CheckIcon,
//       items: [
...
//         { text: "Funding Guidance: Steps to source MON liquidity for on-chain execution", completed: true },
...
//       description: "Expanding MnadAI's AI functionalities to include staking, governance, and yield optimization.",
//       icon: Clock,
//       items: [
...
//         { text: "Staking & Rewards: Implement stakeTokens for MON and MnadAI-created ERC-20 tokens", completed: false },
...
//         { text: "Multi-Token Support: Extend transferTokens & getBalance to support custom MnadAI ERC-20 tokens", completed: false },
...
//         { text: "Ecosystem Partnerships: Integrate MnadAI with Monad-native DeFi platforms (DEXes, lending protocols)", completed: false },
...
//               The evolution of MnadAI on the Monad blockchain, from concept to ecosystem.
//             </p>
//           </div>
//         </RevealOnScroll>
...
const Roadmap: React.FC = () => {
  const roadmapPhases: RoadmapPhase[] = [
    ...
    },
    {
      ...
      phase: "Phase 2",
      title: "Yield Optimization & Advanced AI Capabilities",
      description: "Expanding MnadAI's AI functionalities to include staking, governance, yield optimization, and a richer agent ecosystem.",
      icon: Clock,
      items: [
        { text: "AI-Driven Governance: Deploy createGovernance for community-based decision-making", completed: false },
        { text: "AI Proposal Engine: Suggest governance proposals based on user activity & transaction trends", completed: false },
        ...
        { text: "Social Agents for X: AI bots to analyze X sentiment, promote MnadAI, and engage users", completed: false },
